...
# Suppression colonnes non numériques restantes
X = X.loc[:, ~X.columns.str.contains("date|street|city|statezip|country", case=False)]
...
res, pred_ridge, y_reel = evaluer("Ridge (baseline)",
    Ridge(alpha=10), X_train_sc, X_test_sc, y_train, y_test)
...
print("🎯 Lance maintenant : python notebooks\\04_series_temporelles.py")